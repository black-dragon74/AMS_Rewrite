                        ...
                        <div class="box-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered">
                                <li class="list-group-item">
                                    <b>Registration ID</b> <span class="pull-right text-red" style="font-weight: 600;"><?php echo $studentInfo->student_code ?></span>
                                </li>
                                <li class="list-group-item">
                                    <b>Name</b> <span class="pull-right text-red" style="font-weight: 600;"><?php echo $studentInfo->name ?></span>
                                </li>
                                <li class="list-group-item">
                                    <b>Email</b> <span class="pull-right text-red" style="font-weight: 600;"><?php echo $studentInfo->email ?></span>
                                </li>
                                <li class="list-group-item">
                                    <b>Stream</b> <span class="pull-right text-red" style="font-weight: 600;"><?php echo $studentInfo->stream ?></span>
                                </li>
                                <li class="list-group-item">
                                    <b>Blood Group</b> <span class="pull-right text-red" style="font-weight: 600;"><?php echo $studentInfo->blood_group ?></span>
                                </li>
                            </ul>
                        </div>
                        <!-- /.box-body -->
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="settings">
                                <form class="form-horizontal" enctype="multipart/form-data" autocomplete="off" method="post" action="<?php echo site_url('student/update_profile') ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <img src="<?php echo $this->crud_model->get_profile_pic('student', $this->session->userdata('student_id'))?>" id="profile-img" alt="User Image" height="100px" width="100px" style="border-radius: 10px;">
                                        </div>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="tab-pane" id="password">
                                <form class="form-horizontal" autocomplete="off" method="post" action="<?php echo site_url('student/update_password')?>">
                                    <div class="form-group">
